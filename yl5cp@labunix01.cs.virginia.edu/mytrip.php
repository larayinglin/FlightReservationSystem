		...
		<header id="fh5co-header-section" class="sticky-banner">
			<div class="container">
				<div class="nav-header">
					...
					<h1 id="fh5co-logo"><a href="index.html"><i class="icon-airplane"></i>G7 Flights</a></h1>
					<!-- START #fh5co-menu-wrap -->
					<nav id="fh5co-menu-wrap" role="navigation">
						<ul class="sf-menu" id="fh5co-primary-menu">
							<li class="active"><a href="index.html">Book Flights</a></li>
							<!-- <li>
								...
								<div class="tabulation animate-box">
								  ...
								  <!-- Nav tabs -->
								   <ul class="nav nav-tabs" role="tablist">
								      <li role="presentation" class="active">
								      	<a href="#one-way" aria-controls="one-way" role="tab" data-toggle="tab">One Way</a>
								      </li>
								      <li role="presentation">
								    	   <a href="#round-trip" aria-controls="round-trip" role="tab" data-toggle="tab">Round Trip</a>
								      </li>
								      <!-- <li role="presentation">
								    	   <a href="#flight" aria-controls="flight" role="tab" data-toggle="tab">Flight Information</a>
								      </li> -->
								   </ul>
								  ...
								  <form method="POST" action="flights.php">
									<div class="tab-content">
										<!-- tap1 here: one way trip -->
									  <div role="tabpanel" class="tab-pane active" id="one-way">
										<div class="row">
											<div class="col-xxs-12 col-xs-6 mt">
												<div class="input-field">
													<label for="from">From:</label>
													<input type="text" class="form-control" name="input_dept_state" placeholder="CA"/>
												</div>
											</div>
											<div class="col-xxs-12 col-xs-6 mt">
												<div class="input-field">
													<label for="from">To:</label>
													<input type="text" class="form-control" name="input_arr_state" placeholder="NY"/>
												</div>
											</div>
											<div class="col-xxs-12 col-xs-6 mt alternate">
												<div class="input-field">
													<label for="date-start">Date:</label>
													<input type="text" class="form-control" id="date-start" name="input_date" placeholder="mm/dd/yyyy"/>
												</div>
											</div>
											<!-- <div class="col-xxs-12 col-xs-6 mt alternate">
												<div class="input-field">
											...
											<div class="col-sm-12 mt">
												<section>
													...
													<select class="cs-select cs-skin-border" name="input_class">
														<option value="economy" disabled selected>Economy</option>
														<option value="economy">Economy</option>
														<option value="extraeconomy">Extra Economy</option>
											...
											<div class="col-xxs-12 col-xs-6 mt">
												<section>
													...
													<input type="number" class="form-control" name="adult_num" value="1" placeholder="1"/>
									  ...
									  <!-- tap2 here: round trip -->
									  <div role="tabpanel" class="tab-pane" id="round-trip">
										<div class="row">
											<div class="col-xxs-12 col-xs-6 mt">
												<div class="input-field">
													<label for="from">From:</label>
													<input type="text" class="form-control" name="input_dept_state" value="CA" placeholder="CA"/>
												</div>
											</div>
											<div class="col-xxs-12 col-xs-6 mt">
												<div class="input-field">
													<label for="from">To:</label>
													<input type="text" class="form-control" name="input_arr_state" value="NY" placeholder="NY"/>
												</div>
											</div>
											<div class="col-xxs-12 col-xs-6 mt alternate">
												<div class="input-field">
													<label for="date-start">Date:</label>
													<input type="text" class="form-control" id="date-start" name="input_date" value="" placeholder="mm/dd/yyyy"/>
												</div>
											</div>
											<div class="col-xxs-12 col-xs-6 mt alternate">
												<div class="input-field">
													<label for="date-end">Return Date:</label>
													<input type="text" class="form-control" id="date-end" name="input_date_return" value="" placeholder="mm/dd/yyyy"/>
												</div>
											</div>
											<div class="col-sm-12 mt">
												<section>
			...
			<div class="container">
				<div class="row">
					<div class="col-md-8 col-md-offset-2 text-center heading-section animate-box">
						<h3>Book A Flight</h3>
						<p>Welcome to our G7 Flight Booking Website! Enjoy your experience here.</p>
					</div>
				</div>
