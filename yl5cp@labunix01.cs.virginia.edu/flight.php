...
{
	$input_flight_num = $_POST["input_flight_num"];   //HINT: Use the values from Form method
...
// from fm natural join price where flightNum=" . $input_flight_num;
$sql = "select distinct flightNum, departIATA, arriveIATA, timeDepart, timeArrive
from fm natural join price 
where flightNum=" .$input_flight_num;
				...
				<div class="nav-header">
					...
					<nav id="fh5co-menu-wrap" role="navigation">
						<ul class="sf-menu" id="fh5co-primary-menu">
							<li><a href="index.html">Book Flights</a></li>
							<!-- <li>
...
if ($result->num_rows > 0) {
  echo "<br><br><br><br><h2><b>Flight Number: " . $input_flight_num . "</b></h2>";
  echo "<h2>Date: " . $input_date . "</h2><br>";
  echo "<table class=\"table table-striped\"><thead><tr><th scope=\"col\" colspan=\"1.5\">Depart IATA</th><th scope=\"col\" colspan=\"0.5\">Time</th><th scope=\"col\" colspan=\"1.5\">Arrive IATA</th><th scope=\"col\" colspan=\"0.5\">Time</th></tr></thead>";
  while($row = $result->fetch_assoc()) {
	if ($row["WiFi"]==0){$wifi="N";} else {$wifi="Y";}
	if ($row["Power"]==0){$power="N";} else {$power="Y";}
	echo "<tbody><tr><td scope=\"row\"><h3>" . $row["departIATA"] . "</h3></td>";
	echo "<td scope=\"row\"><h3>" . $row["timeDepart"] . "</h3></td>";
	echo "<td scope=\"row\"><h3>" . $row["arriveIATA"] . "</h3></td>";
	echo "<td scope=\"row\"><h3>" . $row["timeArrive"] . "</h3></td>";
  } 
  echo "</tr></tbody></table><br><br><br><br>";
} else {
  echo "0 results<br><br><br><br>";
}
